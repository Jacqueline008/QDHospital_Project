...
<head>
    ...
    <!--css-this-->
    <link rel="stylesheet" href="/HOS/Public/libs/css/Sys/Hospital/css_add.css">
</head>
<body>
...
<form id="add_container">
    <!--新增容器中的标题-->
    <div class="add_title">医院新增</div>

    <!--新增容器中的输入容器-->
    <div class="input_container">
        <span class="input_label">医院代码</span>
        <div class="input_content">
            <input class="hos_code" type="text" placeholder="请输入医院代码(20个字符内)" required>
        </div>
    </div>
    ...
    <div class="input_container">
        ...
        <div class="input_content">
            <input class="hos_name" type="text" placeholder="请输入医院名称(40个字符内)" required>
        </div>
    </div>
...
<script>
    //新增提交按钮需要ajax请求的地址
    var submitUrl="http://<?php echo C('IP_URL');?>/HOS/Sys/Hospital/add";
    //医院管理-医院展示的页面地址
    var GOTOUrl="http://<?php echo C('IP_URL');?>/HOS/Sys/Hospital/lst";
</script>
<script src="/HOS/Public/libs/js/Sys/Hospital/js_add.js"></script>
