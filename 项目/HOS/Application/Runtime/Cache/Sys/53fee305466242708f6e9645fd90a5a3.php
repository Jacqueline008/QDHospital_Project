...
<head>
    ...
    <!--css-this-->
    <link rel="stylesheet" href="/HOS/Public/libs/css/Sys/Hosadmin/css_add.css">
</head>
<body>
...
<script>
    //新增提交按钮需要ajax请求的地址
    var submitUrl="http://<?php echo C('IP_URL');?>/HOS/Sys/Hosadmin/add";
    //医院管理-医院展示的页面地址
    var GOTOUrl="http://<?php echo C('IP_URL');?>/HOS/Sys/Hosadmin/lst";
</script>
<script src="/HOS/Public/libs/js/Sys/Hosadmin/js_add.js"></script>
