...
<head>
    ...
    <!--css-this-->
    <link rel="stylesheet" href="/HOS/Public/libs/css/Hos/Blacklist/css_lst.css">
</head>
<body>
...
<div class="info-content-mobile">
    ...
    <div class="list-container-m">
        <?php if(is_array($blacklist_table)): $i = 0; $__LIST__ = $blacklist_table;if( count($__LIST__)==0 ) : echo "$empty2" ;else: foreach($__LIST__ as $key=>$blacklist_row): $mod = ($i % 2 );++$i;?><div class="list-item-m">
                <span class="p_name-m"><?php echo ($blacklist_row["p_name"]); ?></span>
                <span class="p_id-m"><?php echo ($blacklist_row["p_id"]); ?></span>
                <span class="begin_date-m"><?php echo ($blacklist_row["begin_date"]); ?>&nbsp至&nbsp</span>
                <span class="end_date-m"><?php echo ($blacklist_row["end_date"]); ?></span>
                <div class="btn-container-m">
                    <div class="btn-del-m" name="<?php echo ($blacklist_row["p_id"]); ?>"><img src="/HOS/Public/images/del-orange.png"><span>删除</span></div>
                </div>
...
<div id="info-container">
    ...
    <div class="info-list">
        ...
        <a href="http://<?php echo C('IP_URL');?>/HOS/Hos/Blacklist/lst" class="active"><img src="/HOS/Public/images/BlacklistController.png"/>黑名单功能</a>
    ...
    <div class="info-content">
        ...
        <div class="list-container">
            ...
            <?php if(is_array($blacklist_table)): $i = 0; $__LIST__ = $blacklist_table;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$blacklist_row): $mod = ($i % 2 );++$i;?><div class="list-item">
                    <span class="p_name"><?php echo ($blacklist_row["p_name"]); ?></span>
                    <span class="p_id"><?php echo ($blacklist_row["p_id"]); ?></span>
                    <span class="begin_date"><?php echo ($blacklist_row["begin_date"]); ?></span>
                    <span class="end_date"><?php echo ($blacklist_row["end_date"]); ?></span>
                    <div class="btn-container">
                        <div class="btn-del" name="<?php echo ($blacklist_row["p_id"]); ?>"><img src="/HOS/Public/images/del-orange.png"><span>删除</span></div>
                    </div>
...
<script>
    //点击删除请求逻辑的地址
    var delUrl="http://<?php echo C('IP_URL');?>/HOS/Hos/Blacklist/del";
</script>
<script src="/HOS/Public/libs/js/Hos/Blacklist/js_lst.js"></script>
