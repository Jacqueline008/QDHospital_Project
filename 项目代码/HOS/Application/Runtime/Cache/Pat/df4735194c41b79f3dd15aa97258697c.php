...
<head>
    ...
    <!--css-this-->
    <link rel="stylesheet" href="/HOS/Public/libs/css/Pat/Treatment/css_docShow.css">
</head>
<body>
...
<div id="info_container">
    <div class="inner-container">
        <img class="doc_pic"src="<?php echo ($doctor_row["doc_pic"]); ?>">
        <div class="doc_name"><?php echo ($doctor_row["doc_name"]); ?></div>
        <div class="mix1">
            <span class="dep_name"><?php echo ($doctor_row["dep_name"]); ?></span>
            <span class="doclevel_name"><?php echo ($doctor_row["doclevel_name"]); ?></span>
        </div>
        <div class="hos_name">医院：<?php echo ($doctor_row["hos_name"]); ?></div>
        <div class="mix2">
            <span class="doc_sex">性别：
                <?php if($doctor_row["doc_sex"] == 'M'): ?>男<?php endif; ?>
                <?php if($doctor_row["doc_sex"] == 'F'): ?>女<?php endif; ?>
            </span>
            <span class="doc_age">年龄：<?php echo ($doctor_row["doc_age"]); ?></span>
        </div>
        <div class="doc_area">擅长领域：<?php echo ($doctor_row["doc_area"]); ?>
        </div>
    </div>
</div>
