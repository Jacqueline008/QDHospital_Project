...
<head>
    ...
    <!--css-this-->
    <link rel="stylesheet" href="/HOS/Public/libs/css/Hos/Dep/css_edit.css">
</head>
<body>
...
<form id="add_container">
    ...
    <div class="input_container disable">
        ...
        <div class="input_content">
            <input class="dep_code disable" type="text" value="<?php echo ($department_row["dep_code"]); ?>" disabled>
        </div>
    </div>
    ...
    <div class="input_container disable">
        ...
        <div class="input_content">
            <input class="dep_name disable" type="text" value="<?php echo ($department_row["dep_name"]); ?>" disabled>
        </div>
    </div>
    ...
    <div class="input_container disable">
        ...
        <div class="input_content">
            <input class="dic_value disable" type="text" value="<?php echo ($department_row["dic_value"]); ?>" disabled>
        </div>
    </div>
    ...
    <div class="input_container texterea_container">
        ...
        <div class="input_content">
            <textarea class="dep_description" placeholder="未编辑科室简介(500个字内)" required maxlength="500"><?php echo ($department_row["dep_description"]); ?></textarea>
        </div>
    </div>
...
<script>
    //提交按钮需要ajax请求的地址
    var submitUrl="http://<?php echo C('IP_URL');?>/HOS/Hos/Dep/edit";
    //科室管理-科室展示的页面地址
    var GOTOUrl="http://<?php echo C('IP_URL');?>/HOS/Hos/Dep/lst";
</script>
<script src="/HOS/Public/libs/js/Hos/Dep/js_edit.js"></script>
