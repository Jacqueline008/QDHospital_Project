...
<head>
    ...
    <!--css-this-->
    <link rel="stylesheet" href="/HOS/Public/libs/css/Pat/Treatment/css_hospitalShow.css">
</head>
<body>
...
<div class="carousel slide" data-ride="carousel" id="mycarousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active qh001" name="QH001">
...
<div class="info-content">
    <!--部分1:搜索栏部分 begin-->
    <form class="ic-search" method="get" action="http://<?php echo C('IP_URL');?>/HOS/Pat/Treatment/hospitalShow" target="_self" onsubmit="formSubmit()">
    ...
    <div class="list-container">
        <?php if(is_array($hospital_table)): $i = 0; $__LIST__ = $hospital_table;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$hospital_row): $mod = ($i % 2 );++$i;?><div class="list-item" name="<?php echo ($hospital_row["hos_code"]); ?>">
    ...
    <div class="list-container-m">
        <?php if(is_array($hospital_table)): $i = 0; $__LIST__ = $hospital_table;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$hospital_row): $mod = ($i % 2 );++$i;?><div class="list-item-m" name="<?php echo ($hospital_row["hos_code"]); ?>">
                <img src="<?php echo ($hospital_row["pic"]); ?>">
...
<script>
    //点击每一个医院跳转的地址
    var GOTOUrl="http://<?php echo C('IP_URL');?>/HOS/Pat/Treatment/departmentShow";
</script>
<script src="/HOS/Public/libs/js/Pat/Treatment/js_hospitalShow.js"></script>
