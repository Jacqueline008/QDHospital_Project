...
<head>
    ...
    <!--css-this-->
    <link rel="stylesheet" href="/HOS/Public/libs/css/Pat/Login/css_login.css">
</head>
<body>
    ...
    <div class="right">
        ...
        <div class="input_container">
            ...
            <div class="input_content">
                <input class="p_name" type="text" placeholder="请输入您的真实姓名" required autocomplete="on">
            </div>
        </div>
        <div class="error error_p_name"></div>

        <div class="input_container">
            <span class="input_label">身份证号</span>
            <div class="input_content">
                <input class="p_id" type="text" placeholder="请输入您的身份证号" required autocomplete="on">
            </div>
        </div>
        <div class="error error_p_id"></div>

        <div class="input_container">
            <span class="input_label">手机号</span>
            <div class="input_content">
                <input class="p_tel" type="text" placeholder="请输入您的手机号" required autocomplete="on">
            </div>
        </div>
...
<script>
    //登录按钮需要ajax请求的地址
    var submitUrl="http://<?php echo C('IP_URL');?>/HOS/Pat/Login/login";
    //网站首页（医院展示）的地址
    var HomeUrl="http://<?php echo C('IP_URL');?>/HOS/Pat/Treatment/hospitalShow";
</script>
<script src="/HOS/Public/libs/js/Pat/Login/js_login.js"></script>
<!--******js-this end******-->
</html>